              ...
              {!showCustom ? (
                ...
                <form onSubmit={(e) => {
                  ...
                  if (customEmail && customName) {
                    onSelect(customEmail.trim(), customName.trim());
                  }
                }} style={{ display: "grid", gap: "0.8rem" }}>
                  <div className="field">
                    <label style={{ fontSize: "0.75rem", color: "#5f6368" }}>Nama Lengkap Google</label>
                    <input
                      type="text"
                      ...
                      required
                      style={{ padding: "0.6rem 0.8rem", borderRadius: "6px", border: "1px solid var(--border)", fontSize: "0.85rem" }}
                    />
                  </div>

                  <div className="field">
                    <label style={{ fontSize: "0.75rem", color: "#5f6368" }}>Alamat Email Google</label>
                    <input
                      type="email"
